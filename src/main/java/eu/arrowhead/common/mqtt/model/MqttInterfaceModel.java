...
public record MqttInterfaceModel(
	...
	public MqttInterfaceModel {
		...
		Assert.isTrue(!Utilities.isEmpty(policy), "'policy' is missing or empty");
	...
	public static class Builder {
		...
		private ServiceInterfacePolicy policy = ServiceInterfacePolicy.NONE;
		...
		//-------------------------------------------------------------------------------------------------
		public Builder policy(final ServiceInterfacePolicy policy) {
			if (policy != null) {
				this.policy = policy;
			}
