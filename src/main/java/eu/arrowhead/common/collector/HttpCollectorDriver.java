...
@Service
public class HttpCollectorDriver {
	...
	@Autowired
	private NotEmptyStringSetValidator notEmptyStringSetValidator;
	...
	private HttpInterfaceModel createHttpInterfaceModel(final String templateName, final Map<String, Object> properties) {
		...
		final Map<String, HttpOperationModel> operations = (Map<String, HttpOperationModel>) httpOperationsValidator
	...
	private MqttInterfaceModel createMqttInterfaceModel(final String templateName, final Map<String, Object> properties) {
		...
		final Set<String> operations = (Set<String>) notEmptyStringSetValidator
